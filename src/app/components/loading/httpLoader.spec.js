...
describe('Angular HTTP loader', function() {
    ...
    describe('no defined methods', function() {
        ...
        it('should open and close the loader', function() {
            ...
            //Assert.
            expect(elem.find('div').attr('class')).not.util.contains('ng-hide');
    ...
    describe('lowercase method', function() {
        beforeEach(function() {
            compileDirective('<div ng-http-loader methods="get" '+'template="example-loader.tpl.html"></div>');
        });
